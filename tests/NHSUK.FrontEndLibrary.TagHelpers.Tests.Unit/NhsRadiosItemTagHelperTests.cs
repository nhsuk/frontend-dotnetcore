...
{
    public class NhsRadiosItemTagHelperTests
  {
        private readonly TagHelperOutput _tagHelperOutput;
        public NhsRadiosItemTagHelperTests()
        {
            var tagHelper = new NhsRadiosItemTagHelper();
        ...
        {
            Assert.Equal(CssClasses.NhsUkRadiosItem, _tagHelperOutput.Attributes[HtmlAttributes.ClassAttribute].Value);
        }
