...
namespace NHSUK.FrontEndLibrary.TagHelpers.Tests.Unit
{
  public class TestableHtmlGenerator : DefaultHtmlGenerator
  {
    ...
    public IDictionary<string, object> ValidationAttributes1 => _validationAttributes;
    ...
    public static ViewContext GetViewContext(
        ...
        IModelMetadataProvider metadataProvider)
    {
      return GetViewContext(model, htmlGenerator, metadataProvider, new ModelStateDictionary());
    }
