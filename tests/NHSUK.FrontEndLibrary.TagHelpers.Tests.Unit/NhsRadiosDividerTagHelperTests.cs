...
{
    public class NhsRadiosDividerTagHelperTests
  {
        private readonly TagHelperOutput _tagHelperOutput;
        public NhsRadiosDividerTagHelperTests()
        {
            var tagHelper = new NhsRadiosDividerTagHelper();
        ...
        {
            Assert.Equal(CssClasses.NhsUkRadiosDivider, _tagHelperOutput.Attributes[HtmlAttributes.ClassAttribute].Value);
        }
